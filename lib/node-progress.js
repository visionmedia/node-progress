...
ProgressBar.prototype.tick = function(len, tokens){
  ...
  this.stream.write('\r\033[2K' + this.toString(tokens));
};


/**
 * "increase" the progress bar with optional `len`
 *
 * @param {Number} len
 * @api public
 */

ProgressBar.prototype.increase = function(len){
  // start time for eta
...
/**
 * "toString" the progress bar with optional `tokens`
 *
 * @param {Object} tokens
 * @api public
 */

ProgressBar.prototype.toString = function(tokens){
